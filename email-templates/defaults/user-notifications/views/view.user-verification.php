...
<body style="background-color: #FFF8F5">
	<table align="center" width="700" style="padding: 50px 50px 20px 50px">
		<tr>
			<td align="center">
				<!--<a href="<?=$_app_domain?>/verify.php?code=<?=$_verification_code?>&lang=<?=$_user_lang?>" target="_blank">	
				    <img src="<?//=$_email_manager->getHeaderImage( )?>" style="display: block; max-width:450px;" alt="<?=$_company_name?>" />
				</a>-->
				&nbsp;
			</td>
		</tr>
		<tr>
			<td align="center">
				<h4 style="color: #000938; font-size:32px; margin:20px; text-align: center; font-weight: bolder; font-family: 'Poppins', 'Arial' , 'Serif';">
					<?=$_lang->val( 'registration_hi' )?> <span style="text-transform: capitalize;"><?=ucwords( $_client_name )?>!</span> 
					<br>
					<?=$_lang->val( 'registration_welcome', ["_company_name" => $_company_name])?>
				</h4>
			</td>
		</tr>
	</table>
		...
		<tr>
			<td>
				<p style="text-align: center; font-size: 15px;color: #000938; font-family:'Poppins', 'Arial' , 'Serif';" > 
					<?=$_lang->val( 'email_user_registration_verify_1' )?>
					<br><br>
					<?=$_lang->val( 'email_user_registration_verify_2' )?>
				</p> 
			</td>
		</tr>
		<tr>
			<td align="center">
				<a href="<?=$_app_domain?>/verify-account/<?=$_verification_code?>/<?=$_user_lang?>/"> 
		...
		<tr>
			<td align="center">
				<p style="line-height: 30px;text-align: center; font-size: 15px ; color:#9BABC5; font-family: 'Poppins', 'Arial' , 'Serif';">  
					...
					<br> 
					<a href="<?=$_app_domain?>/verify-account/<?=$_verification_code?>/<?=$_user_lang?>/" target="_blank" style="text-align: center; text-decoration: underline; font-size: 15px ; color:#6B75FF ; a:active color:#1155CC; a:hover cursor: pointer; a:visited color:#6611CC; font-family:'Poppins', 'Arial' , 'Serif';"> 
						<?=$_app_domain?>/verify-account/<?=$_verification_code?>/<?=$_user_lang?>/
					</a> 
				</p>
			</td>
		</tr>
